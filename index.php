...
<div class="tracking-sec" data-bs-spy="scroll" data-bs-target="#navbar-example2" data-bs-offset="0" class="scrollspy-example" tabindex="0">
     <div class="container pt-3" id="home">
          ...
          <div class="container w-75 pt-5">
               ...
               <div class="">
                    <p>The shipping saints Express Reference Tracking></p>
               </div>
               ...
               <div class="col-lg-3">
                    <div class="card text-dark mb-3 card-inquiry bg-white card-for-buz courser-pointer">
                         <div class="card-body text-center ">
                              ...
                              <h6 class="card-text hoverDesc">
                                   The shipping saints For Business
                              </h6>
                              <p class="card-text fwt-sm fw-light">
               ...
               <div class="row">
                    ...
                    <div class="col-lg-3">
                         <div>
                              ...
                              <p class="card-text-hover fw-1">Shipping saints Express</p>
                              <p class="card-text-hover fw-1">Shipping saints Global Forwarding</p>
                              <p class="card-text-hover fw-1">Shipping saints Freight</p>
                              <p class="card-text-hover fw-1">Shipping saints Supply Chain</p>
                              <p class="card-text-hover fw-1">Shipping saints eCommerce solution</p>
                         </div>
                    </div>
                    ...
                    <div class="col-lg-3">
                         <div>
                              ...
                              <p class="card-text-hover fw-1"> About Shipping saints</p>
